          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Have questions about our bug bite identifier? Need help understanding a bite analysis? 
              ...
              <div className="mt-8 p-4 bg-yellow-50 rounded-lg">
                <h3 className="text-yellow-800 font-semibold mb-2">Medical Emergency?</h3>
                <p className="text-yellow-700 text-sm">
                  If you're experiencing severe symptoms, allergic reactions, or are concerned about a bite,
